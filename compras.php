...
<main>
    <div class="container p-4">
        <h1 class="display-4 mb-4">Mis Pedidos</h1>
        <hr>
        ...
        <?php while ($row = $sql->fetch(PDO::FETCH_ASSOC)) { ?>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    Pedido realizado el <?php echo $row['fecha']; ?>
                </div>
                ...
                <div class="card-body">
                    ...
                    <a href="compra_detalle.php?orden=<?php echo $row['id_transaccion']; ?>&token=<?php echo $token; ?>" class="btn btn-warning">Ver Detalles del Pedido</a>
                </div>
            </div>
