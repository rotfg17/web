...
$sql = $con->prepare("SELECT id, nombre, precio FROM productos WHERE id_categoria=112 and activo=1 ");
$sql->execute();
...
<body>
   ...
   <section class="paginacion">
    <ul>
        <li><a href="pintura.php" >1</a></li>
        <li><a href="pinturapag2.php">2</a></li>
        <li><a href="pinturapag3.php"class="active">3</a></li>
        <li><a href="pinturapag4.php">4</a></li>
        <li><a href="pinturapag5.php">5</a></li>
    </ul>
</section>
