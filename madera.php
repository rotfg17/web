...
$sql = $con->prepare("SELECT id, nombre, precio FROM productos WHERE id_categoria = 11 LIMIT :offset, :resultados_por_pagina");
...
$sql_count = $con->prepare("SELECT COUNT(*) AS total FROM productos WHERE id_categoria = 11");
...
<html lang="en">
    <head>
        ...
        <title>Ferre Seibo - Madera</title>
    </head>
<body>
...
<?php include 'menu.php'; ?>
   ...
   <img class="img-responsive vdk" src="img/madera.webp" alt="madera" width="100%" height="auto" ></a> 
    </div>
...
<section class="paginacion">
    <ul>
        ...
        for ($i = 1; $i <= $total_paginas; $i++) {
            ...
            echo "<li><a href='madera.php?pagina=$i' class='$claseActiva'>$i</a></li>";
        }
        ?>
    </ul>
</section>
