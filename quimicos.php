...
$sql = $con->prepare("SELECT id, nombre, precio FROM productos WHERE id_categoria = 16 LIMIT :offset, :resultados_por_pagina");
...
$sql_count = $con->prepare("SELECT COUNT(*) AS total FROM productos WHERE id_categoria = 16");
$sql_count->execute();
...
<html lang="en">
    <head>
        ...
        <title>Ferre Seibo - Quimicos</title>
    </head>
<body>
...
<?php include 'menu.php'; ?> 
   ...
   <img class="img-responsive vdk" src="img/quimicos.webp" alt="quimicos" width="100%" height="auto" >
    </div>
...
<section class="paginacion">
    <ul>
        ...
        for ($i = 1; $i <= $total_paginas; $i++) {
            ...
            echo "<li><a href='quimicos.php?pagina=$i' class='$claseActiva'>$i</a></li>";
        }
        ?>
    </ul>
</section>
