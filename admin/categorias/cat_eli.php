...
$sql = "SELECT id, nombre FROM categoria WHERE activo = 0"; // Consulta SQL para seleccionar categorías inactivas
$resultado = $con->query($sql); // Ejecuta la consulta SQL
$categorias = $resultado->fetchAll(PDO::FETCH_ASSOC); // Almacena los resultados en un arreglo asociativo
