...
function validaToken($id, $token, $con)
{
    ...
    if ($sql->fetchColumn() > 0) {
        if (activarUsuario($id, $con)) {
            header("Location: template.php?mensaje=<p>¡Enhorabuena! Tu cuenta ha sido activada con éxito. Ahora estás listo para aprovechar al máximo nuestros servicios. Si tienes alguna pregunta o necesitas asistencia, no dudes en ponerte en contacto con nuestro equipo de soporte. ¡Bienvenido y gracias por unirte a nosotros!</p>");
            exit;
        } else {
