...
$sql = $con->prepare("SELECT id, nombre, precio FROM productos WHERE id_categoria = 9 LIMIT :offset, :resultados_por_pagina");
...
$sql_count = $con->prepare("SELECT COUNT(*) AS total FROM productos WHERE id_categoria = 9");
...
<html lang="en">
    <head>
        ...
        <title>Ferre Seibo - Herreria</title>
    </head>
<body>
...
<div class="banner-especial -1r">
   <img class="img-responsive vdk" src="img/herreria.webp" alt="herreria" width="100%" height="auto" >
    </div>
...
<section class="paginacion">
    <ul>
        ...
        for ($i = 1; $i <= $total_paginas; $i++) {
            ...
            echo "<li><a href='herreria.php?pagina=$i' class='$claseActiva'>$i</a></li>";
        }
        ?>
    </ul>
</section>
