...
$sql = $con->prepare("SELECT id, nombre, precio FROM productos WHERE id_categoria = 14 LIMIT :offset, :resultados_por_pagina");
...
$sql_count = $con->prepare("SELECT COUNT(*) AS total FROM productos WHERE id_categoria = 14");
$sql_count->execute();
...
<html lang="en">
    <head>
        ...
        <title>Ferre Seibo - Plomería</title>
    </head>
<body>
...
<section class="paginacion">
    <ul>
        ...
        for ($i = 1; $i <= $total_paginas; $i++) {
            ...
            echo "<li><a href='plomeria.php?pagina=$i' class='$claseActiva'>$i</a></li>";
        }
        ?>
    </ul>
</section>
